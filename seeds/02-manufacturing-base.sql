-- 02-manufacturing-base.sql
-- Seed for clips 3.2.3 onwards.
-- Applied via: pnpm run-sql seeds/02-manufacturing-base.sql
--
-- Prepared bridge columns:
-- - maintenance_log.planned_at supports Tank.scheduleMaintenance in 3.2.3.
-- - batch.planned_transfer_at supports extendRest/scheduleEarlyTransfer in 3.4.2.
...
INSERT INTO manufacturing.batch (id, recipe_id, target_volume, status, planned_start, planned_transfer_at, current_sugar_level, current_temperature, days_fermenting, assigned_tank_id, assigned_operator_id, last_operator_note) VALUES
  ...
  ('B-2120', 'REC-LAGER-V3',   200, 'queued', '2026-05-01', NULL, NULL, NULL, NULL, 'T-7',  'op-park',  NULL),
  ('B-2121', 'REC-PILSNER-V2', 150, 'queued', '2026-05-01', NULL, NULL, NULL, NULL, 'T-7',  'op-park',  NULL),
  ('B-2122', 'REC-WHEAT-V1',   150, 'queued', '2026-05-02', NULL, NULL, NULL, NULL, 'T-7',  'op-park',  NULL),
  ...
  ('B-2117', 'REC-CITRA-IPA',  100, 'queued',     '2026-05-05', NULL, NULL,  NULL, NULL, NULL, 'op-park', NULL),
  ('B-2118', 'REC-CITRA-IPA',  200, 'queued',     '2026-05-06', NULL, NULL,  NULL, NULL, NULL, 'op-park', NULL),
  ('B-2125', 'REC-CITRA-IPA',  150, 'queued',     '2026-05-01', NULL, NULL,  NULL, NULL, NULL, 'op-park', NULL),
  ('B-2126', 'REC-LAGER-V3',   200, 'queued',     '2026-05-03', NULL, NULL,  NULL, NULL, NULL, 'EMP-2847', NULL)
ON CONFLICT (id) DO NOTHING;
