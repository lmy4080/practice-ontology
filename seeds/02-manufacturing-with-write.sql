-- 02-manufacturing-with-write.sql
-- Post-write variant of 02-manufacturing-base.sql.
-- Applied via: pnpm run-sql seeds/02-manufacturing-with-write.sql
--
-- Reflects the state after the shift-report agent processed Park Kyungwon's
-- 2026-04-30 evening handover note:
--   - T-7 taken offline for inspection (status=maintenance) + scheduled
--     maintenance log ML-T7-2026-04-30-tdyd.
--   - Its queued batches deferred off the offline tank: B-2120 -> 2026-05-03,
--     B-2121 -> 2026-05-03, B-2122 -> 2026-05-04.
--   - B-2126 deferred independently (hop delivery slipped ~1 week) -> 2026-05-10.
--   - audit_log seeded with the 5 resulting action invocations.
